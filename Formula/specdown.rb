class Specdown < Formula
  ...
  url "https://github.com/specdown/specdown/archive/v1.2.32.tar.gz"
  sha256 "0e445b911d20e91e2e0b1be80fa5638743128a98cad3dd266634632ba6dc784a"

  depends_on "help2man" => :build
  depends_on "rust" => :build

  resource("testdata") do
    url "https://raw.githubusercontent.com/specdown/specdown/v1.2.32/README.md"
